...
namespace JPSHolidayTrackerSystem.Api.Migrations
{
    ...
    [Migration("20200304151120_Departments")]
            ...
            modelBuilder.Entity("JPSHolidayTrackerSystem.Shared.Entitities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Gender = 0,
                            IsActive = true,
                            JoinedDate = new DateTime(2020, 3, 4, 15, 11, 19, 820, DateTimeKind.Local).AddTicks(5291),
                            LastName = "Smith",
                            Phone = "324777888773"
                        },
                        new
                        {
                            ...
                            Gender = 0,
                            IsActive = true,
                            JoinedDate = new DateTime(2020, 3, 4, 15, 11, 19, 823, DateTimeKind.Local).AddTicks(8276),
                            LastName = "Duff",
                            Phone = "0777777777"
                        },
                        new
                        {
                            ...
                            Gender = 0,
                            IsActive = true,
                            JoinedDate = new DateTime(2020, 3, 4, 15, 11, 19, 823, DateTimeKind.Local).AddTicks(8359),
                            LastName = "Edwards",
                            Phone = "0777777777"
                        });
                });
